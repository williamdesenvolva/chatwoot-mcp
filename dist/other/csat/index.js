    ...
    try {
        ...
        switch (name) {
            ...
            case 'get_csat_response': {
                const responseId = args?.csat_response_id;
                result = await client.get(client.accountPath(`/csat_survey_responses/${responseId}`));
                break;
            }
            case 'download_csat_reports': {
                ...
                if (args?.inbox_id)
                    params.inbox_id = args.inbox_id;
                result = await client.get(client.accountPath('/csat_survey_responses/download'), params);
                break;
            }
            default:
