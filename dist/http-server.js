    ...
    switch (name) {
        ...
        case 'execute_ai_task': {
            ...
            if (args.conversation_id)
                executionData.conversation_id = args.conversation_id;
            if (args.contact_id)
                executionData.contact_id = args.contact_id;
        ...
        case 'list_ai_task_executions': {
            const params = {};
            if (args.template_id)
                params.ai_task_template_id = args.template_id;
            if (args.status)
                params.status = args.status;
            if (args.page)
                params.page = args.page;
        ...
        case 'send_ai_task_feedback': {
            ...
            if (args.comment)
                feedbackData.feedback_comment = args.comment;
        ...
        case 'create_process': {
            ...
            if (args.description)
                processData.description = args.description;
        ...
        case 'get_process_cards': {
            const params = {};
            if (args.process_id)
                params.process_id = args.process_id;
            if (args.stage_id)
