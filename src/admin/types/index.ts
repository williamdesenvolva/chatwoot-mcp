...
export interface CreateTokenResponse {
  ...
  plain_token: string; // Only shown once!
}
...
export interface TokenValidation {
  ...
  isLegacy?: boolean;
  rateLimit?: number;
  // Captain JWT token fields
  accountId?: number;
  assistantId?: number;
}

// Full permissions preset
export const FULL_PERMISSIONS: TokenPermissions = PERMISSION_CATEGORIES.reduce(
  (acc, category) => ({
    ...acc,
...
export const READ_ONLY_PERMISSIONS: TokenPermissions = PERMISSION_CATEGORIES.reduce(
  (acc, category) => ({
    ...acc,
...
export const NO_PERMISSIONS: TokenPermissions = PERMISSION_CATEGORIES.reduce(
  (acc, category) => ({
    ...acc,
