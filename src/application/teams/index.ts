    ...
    switch (name) {
      case 'list_teams': {
        result = await client.get<Team[]>(
          client.accountPath('/teams')
        );
        break;
      }

      case 'create_team': {
        result = await client.post<Team>(
          client.accountPath('/teams'),
      ...
      case 'get_team': {
        ...
        result = await client.get<Team>(
          client.accountPath(`/teams/${teamId}`)
        );
        break;
      }
      ...
      case 'update_team': {
        ...
        result = await client.patch<Team>(
          client.accountPath(`/teams/${teamId}`),
          updateData
        );
        break;
      ...
      case 'list_team_members': {
        ...
        result = await client.get(
          client.accountPath(`/teams/${teamId}/team_members`)
        );
        break;
      }
