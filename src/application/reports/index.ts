  ...
  try {
    ...
    switch (name) {
      case 'get_account_summary': {
        ...
        result = await client.get<Report[]>(
          client.accountPath('/reports/summary'),
          params
        );
        break;
      }
      ...
      case 'get_conversations_report': {
        ...
        if (args?.since) params.since = args.since;
        if (args?.until) params.until = args.until;
        if (args?.timezone_offset) params.timezone_offset = args.timezone_offset;
        result = await client.get<Report[]>(
          client.accountPath('/reports'),
          params
        );
        break;
      }
      ...
      case 'get_agent_report': {
        ...
        if (args?.until) params.until = args.until;
        result = await client.get<Report[]>(
          client.accountPath(`/reports/agents/${agentId}`),
          params
        );
        break;
      }
      ...
      case 'get_inbox_report': {
        ...
        if (args?.until) params.until = args.until;
        result = await client.get<Report[]>(
          client.accountPath(`/reports/inboxes/${inboxId}`),
          params
        );
        break;
      }
      ...
      case 'get_team_report': {
        ...
        if (args?.until) params.until = args.until;
        result = await client.get<Report[]>(
          client.accountPath(`/reports/teams/${teamId}`),
          params
        );
        break;
      }
      ...
      case 'get_label_report': {
        ...
        if (args?.until) params.until = args.until;
        result = await client.get<Report[]>(
          client.accountPath('/reports/labels'),
          params
        );
        break;
      }
